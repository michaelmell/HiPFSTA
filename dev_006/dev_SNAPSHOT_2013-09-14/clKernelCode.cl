							 ...
							 )
{
	...
	if(distToLowerIndex!=0 & distToUpperIndex!=0){
		...
		membraneCoordinatesX[xInd] = (distToLowerIndex * membraneCoordinatesX[closestLowerNoneNanIndexLoc[xInd]] 
									+ distToUpperIndex * membraneCoordinatesX[closestUpperNoneNanIndexLoc[xInd]])
		...
		membraneNormalVectorsX[xInd] = (distToLowerIndex * membraneNormalVectorsX[closestLowerNoneNanIndexLoc[xInd]] 
									  + distToUpperIndex * membraneNormalVectorsX[closestUpperNoneNanIndexLoc[xInd]])
									  /(distToLowerIndex+distToUpperIndex);
		...
		membraneNormalVectorsY[xInd] = (distToLowerIndex * membraneNormalVectorsY[closestLowerNoneNanIndexLoc[xInd]] 
									  + distToUpperIndex * membraneNormalVectorsY[closestUpperNoneNanIndexLoc[xInd]])
									  /(distToLowerIndex+distToUpperIndex);
...
__kernel void filterIncorrectCoordinates(__global double* interCoordinateAngles,
										 __global double* membraneCoordinatesX,
										 __global double* membraneCoordinatesY,
										 __global double* membraneNormalVectorsX,
										 __global double* membraneNormalVectorsY,
										 ...
										 const double maxCoordinateAngle
										 //~ __global double* dbgOut,
										 //~ __global double* dbgOut2
										 )
{
	...
	do{
		...
		if(interCoordinateAngles[closestLowerCorrectIndexLoc[xInd]] > maxCoordinateAngle){
		...
		if(interCoordinateAngles[closestUpperCorrectIndexLoc[xInd]] > maxCoordinateAngle){
	...
	if(distToLowerIndex!=0 & distToUpperIndex!=0){
		//~ membraneCoordinatesX[xInd] = (distToLowerIndex * membraneCoordinatesX[closestLowerCorrectIndexLoc[xInd]] + membraneCoordinatesX[closestUpperCorrectIndexLoc[xInd]])/2;
		membraneCoordinatesX[xInd] = (distToLowerIndex * membraneCoordinatesX[closestLowerCorrectIndexLoc[xInd]] 
									+ distToUpperIndex * membraneCoordinatesX[closestUpperCorrectIndexLoc[xInd]])
									/(distToLowerIndex+distToUpperIndex);
		//~ membraneCoordinatesY[xInd] = (membraneCoordinatesY[closestLowerCorrectIndexLoc[xInd]] + membraneCoordinatesY[closestUpperCorrectIndexLoc[xInd]])/2;
		membraneCoordinatesY[xInd] = (distToLowerIndex * membraneCoordinatesY[closestLowerCorrectIndexLoc[xInd]] 
									+ distToUpperIndex * membraneCoordinatesY[closestUpperCorrectIndexLoc[xInd]])
									/(distToLowerIndex+distToUpperIndex);
		
		//~ membraneNormalVectorsX[xInd] = (membraneNormalVectorsX[closestLowerCorrectIndexLoc[xInd]] + membraneNormalVectorsX[closestUpperCorrectIndexLoc[xInd]])/2;
		...
		//~ membraneNormalVectorsY[xInd] = (membraneNormalVectorsY[closestLowerCorrectIndexLoc[xInd]] + membraneNormalVectorsY[closestUpperCorrectIndexLoc[xInd]])/2;
